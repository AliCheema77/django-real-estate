...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('profiles', '0002_alter_profile_licence'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agent', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='agent_reviews', to='profiles.profile', verbose_name='Agent being rated')),
