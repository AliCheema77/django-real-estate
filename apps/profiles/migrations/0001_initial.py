    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', phonenumber_field.modelfields.PhoneNumberField(default='+923237092316', max_length=30, region=None, verbose_name='Phone Number')),
                ('about_me', models.TextField(default='say something about your self', verbose_name='About me')),
                ('licence', models.CharField(max_length=20, verbose_name='Real Estate Licence')),
                ...
                ('country', django_countries.fields.CountryField(default='PAK', max_length=2, verbose_name='Country')),
                ('city', models.CharField(default='Islamabad', max_length=180, verbose_name='City')),
