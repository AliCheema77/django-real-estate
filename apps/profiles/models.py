...
class Profile(TimeStampedUUIDModel):
    ...
    phone_number = PhoneNumberField(verbose_name=_("Phone Number"), max_length=30, default="+923237092316")
    ...
    country = CountryField(verbose_name=_("Country"), default="PAK", null=False, blank=False)
    city = models.CharField(verbose_name=_("City"), max_length=180, default="Islamabad", null=False, blank=False)
    ...
    def __str__(self):
        return f"{self.user.username}'s prifile"
